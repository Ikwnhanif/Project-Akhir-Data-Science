---
title: "SentimenAnalisis Ulasan Bibit Naive Bayes"
...
bibitdata <- read.csv("ReviewBibitClean2.csv", stringsAsFactors =  FALSE)
review <- as.character(bibitdata$text) #merubah text menjadi char
s <- get_nrc_sentiment(review)

review_combine <- cbind(bibitdata$text,s) #klasifikasi Data
par(mar=rep(3,4))
a <- barplot(colSums(s), col=rainbow(10),ylab='count',main='Sentiment Analisis BIBIT')
brplt <- a
```
